...
const EditModal = ({setShowModal, setShowRemoveModal, link}: ModalType) => {
    ...
    const mutation = trpc.useMutation(["links.update"])

    const createNewLink = () => {
        mutation.mutate({id, slug, url})
    }
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                ...
                {/*body*/}
                    <div className="relative p-6 flex-auto">
                        ...
                        <input className="text-black" name="url" type="text" onChange={handleSlugChange} value={slug}/>
                ...
                {/*footer*/}
                    <div className="flex justify-between border-t border-solid border-slate-200 rounded-b">
                        <button
                        ...
                        <div className="flex items-center justify-end p-4">
                            ...
                            <LoadingButton loading={mutation.isLoading} onClick={() => createNewLink()}>Update ShortLink</LoadingButton>
                        </div>
                    </div>
                </div>
            </div>
